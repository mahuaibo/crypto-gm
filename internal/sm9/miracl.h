...
/*
 *   main MIRACL header - miracl_custom.h.
 */
...
#define _MIPT_  miracl_custom *,
#define _MIPTO_ miracl_custom *
#define _MIPD_  miracl_custom *mr_mip,
#define _MIPDO_ miracl_custom *mr_mip
...
extern miracl_custom *mirsys(miracl_custom *,int,mr_small);
#else
...
/* 
   ...
   Added into miracl_custom.h.  Notice the override of the original declarations
