...
{
	mirkill(x->a.a.a ); mirkill(x->a.a.b );
	mirkill(x->a.b.a ); mirkill(x->a.b.b );
	mirkill(x->b.a.a ); mirkill( x->b.a.b);
	mirkill(x->b.b.a ); mirkill(x->b.b.b );
	mirkill(x->c.a.a ); mirkill(x->c.a.b );
	mirkill(x->c.b.a ); mirkill(x->c.b.b );
}
/****************************************************************
Function: zzn12_copy
