...
func ordInverse(in *[4]uint64) {
	var all [56]uint64
	_1 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(&all))))
	_10 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(_1)) + 32))
	_11 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(_10)) + 32))
	_101 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(_11)) + 32))
	_111 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(_101)) + 32))
	_1001 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(_111)) + 32))
	x4 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(_1001)) + 32))
	x5 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(x4)) + 32))
	x10 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(x5)) + 32))
	x20 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(x10)) + 32))
	x30 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(x20)) + 32))
	x32 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(x30)) + 32))
...
func sm2PointAdd1(res, in1, in2 *[3][4]uint64, all *[12]uint64) {
	//var all [12]uint64
	t1 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(all))))
	t2 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(t1)) + 32))
	t4 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(t2)) + 32))
...
func sm2PointAdd2(res, in1, in2 *[3][4]uint64, all *[44]uint64) {
	//var all [44]uint64
	H3 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(all))))
	H2 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(H3)) + 32))
	H := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(H2)) + 32))
	z11 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(H)) + 32))
	z22 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(z11)) + 32))
	u1 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(z22)) + 32))
	u2 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(u1)) + 32))
	s1 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(u2)) + 32))
	s2 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(s1)) + 32))
	r := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(s2)) + 32))
	r2 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(r)) + 32))
...
func sm2PointDouble1(res, in *[3][4]uint64, all *[16]uint64) {
	xx := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(all))))
	yy := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(xx)) + 32))
	s := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(yy)) + 32))
	m := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(s)) + 32))
...
func sm2PointDouble2(res, in *[3][4]uint64, all *[24]uint64) {
	//var all [24]uint64
	delta := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(all))))
	gamma := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(delta)) + 32))
	beta := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(gamma)) + 32))
	alpha := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(beta)) + 32))
	t1 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(alpha)) + 32))
	t2 := (*[4]uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(t1)) + 32))
